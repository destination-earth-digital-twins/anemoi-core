#!/bin/bash
#SBATCH --output=/pfs/lustrep4/scratch/project_465000527/buurmans/DE_330_WP14/Anemoi/multi-domain-training/anemoi-core/training/logs/test.out
#SBATCH --error=/pfs/lustrep4/scratch/project_465000527/buurmans/DE_330_WP14/Anemoi/multi-domain-training/anemoi-core/training/logs/test.err
#SBATCH --nodes=1
...
#SBATCH --job-name=meps-weighted
#SBATCH --cpus-per-task=7

CONFIG=multi_domain_MEPSonly_StageB.yaml 
...
export VIRTUAL_ENV=/pfs/lustrep4/scratch/project_465000527/buurmans/DE_330_WP14/Anemoi/multi-domain-training/.md
...
srun \
    singularity exec -B /pfs:/pfs \
                     ...
                     -B /opt/cray \
                     -B /usr/lib64 \
        $CONTAINER $CONTAINER_SCRIPT $CONFIG_DIR $CONFIG
