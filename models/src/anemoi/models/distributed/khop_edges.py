...
def get_k_hop_edges(nodes: Tensor, edge_attr: Tensor, edge_index: Adj, num_hops: int = 1, num_nodes: Optional[int] = None) -> tuple[Adj, Tensor]:
    ...
    num_nodes: Optional[int], by default None
...
def sort_edges_1hop_sharding(
    ...
    relabel_dst_nodes : bool, by default False
    ...
    if mgroup:
        ...
        edge_attr_list, edge_index_list = sort_edges_1hop_chunks(
            ...
            edge_index, 
            num_chunks, 
            relabel_dst_nodes=relabel_dst_nodes
            )
...
def sort_edges_1hop_chunks(
    num_nodes: Union[int, tuple[int, int]], edge_attr: Tensor, edge_index: Adj, num_chunks: int,relabel_dst_nodes: bool = False
