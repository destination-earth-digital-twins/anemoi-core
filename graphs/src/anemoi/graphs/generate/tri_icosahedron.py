...
def add_1_hop_edges(
    ...
    for subdivisions in edge_resolutions:
        ...
        print(f"Adding {sphere.edges.shape[0]} unmasked 1-hop edges for resolution {subdivisions}")
    ...
    print(f"unmasked_nodes shape[0]: {unmasked_nodes.shape[0]}")
    if area_mask_builder is not None:
    ...
    print(f"multiscale_edges_shape: {multiscale_edges.shape}")
